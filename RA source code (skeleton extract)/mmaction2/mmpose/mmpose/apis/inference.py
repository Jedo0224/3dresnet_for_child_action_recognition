...
def inference_top_down_pose_model(model,track_id,
                                  imgs_or_paths,
                                  person_results=None,
                                  bbox_thr=None,
                                  format='xywh',
    ...
    for pose, person_result, bbox_xyxy, track in zip(poses, person_results,
                                              bboxes_xyxy,track_id):
        pose_result = person_result.copy()
        pose_result['keypoints'] = pose
        pose_result['bbox'] = bbox_xyxy
        pose_result['track_id'] = track
